...
try {
    ...
    requireAnyPermission($conn, $userData, ['client.view', 'invoice.create', 'invoice.edit', 'journal.create', 'journal.edit', 'journal.import'], 'You do not have permission to load client reference data.');
